...
export const SHOP_CATALOG: ShopItemDefinition[] = [
  ...
  {
    id: 'shop_breakthrough_003',
    definitionId: 'pill_nascent_soul_guard',
    name: '护婴丹',
    icon: '婴',
    category: 'breakthrough',
    type: 'consumable',
    quality: 'supreme',
    basePrice: 1680,
    description: '凝护元神雏形的高阶丹药，提高破入元婴成功率并降低失败损失。',
    effects: [{ type: 'breakthrough_success', value: 0.2 }],
    minRealm: '金丹',
    stockRange: [0, 1],
    refreshWeight: 0.18
  },
  {
    id: 'shop_breakthrough_004',
    definitionId: 'pill_spirit_transform',
    name: '化神丹',
    icon: '神',
    category: 'breakthrough',
    type: 'consumable',
    quality: 'legendary',
    basePrice: 3200,
    description: '引导神识蜕变的秘丹，提高破入化神成功率并保留更多失败修为。',
    effects: [{ type: 'breakthrough_success', value: 0.18 }],
    minRealm: '元婴',
    stockRange: [0, 1],
    refreshWeight: 0.12
  },
  {
    ...
    quality: 'legendary',
    basePrice: 5600,
    description: '护住道心以迎天劫的丹药，提高入渡劫境成功率并显著降低失败损失。',
  ...
  {
    id: 'shop_breakthrough_006',
    definitionId: 'pill_great_ascension',
    name: '大乘悟道丹',
    icon: '乘',
    category: 'breakthrough',
    type: 'consumable',
    quality: 'legendary',
    basePrice: 9200,
    description: '悟通天地法则的稀世丹药，提高破入大乘成功率并降低失败损失。',
    effects: [{ type: 'breakthrough_success', value: 0.14 }],
    minRealm: '渡劫',
    stockRange: [0, 1],
    refreshWeight: 0.05
  },
  {
    id: 'shop_breakthrough_007',
    definitionId: 'pill_immortal_ascension',
    name: '登仙引',
    icon: '仙',
    category: 'breakthrough',
    type: 'consumable',
    quality: 'legendary',
    basePrice: 14800,
    description: '传闻可接引仙机的无上灵药，提高登仙成功率并尽量保全失败根基。',
