...
- [x] 为核心 runtime 增加最小测试：
  ...
  - 当前覆盖 battle runtime、story parser、world tick / world log resolver、player journey resolver、map / sect unlock rules、sect stipend / garden / alchemy / task / facility rules
